...
//////////////////////////
	...
	function init(){  	
		...
		const gsTableLinks =  {
			data:                  "https://docs.google.com/spreadsheets/d/e/2PACX-1vROr9oSvbEvbVim-Wd4iwj795jMAWab8-ittgag92exmbEbx8I5T-4SSLkxlV7b0wHPhhtwiDCd7ipi/pub?gid=0&single=true&output=tsv"
		}

		// 2. Asynchronous data load (with Promise.all) and D3 (Fetch API) 
		d3.tsv("https://docs.google.com/spreadsheets/d/e/2PACX-1vROr9oSvbEvbVim-Wd4iwj795jMAWab8-ittgag92exmbEbx8I5T-4SSLkxlV7b0wHPhhtwiDCd7ipi/pub?gid=0&single=true&output=tsv",
			async (loadedData) => {
	 			let data = 	await parseTable(loadedData)
				await renderVis(data)
			}
		)

		// X. Table data parsing function: trim() header white space and prase numbers with "$" and "," stripped. 
		async function parseTable(tableData){
